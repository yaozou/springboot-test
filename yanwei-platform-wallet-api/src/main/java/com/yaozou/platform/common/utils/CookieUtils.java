 ...
 * Cookie 辅助类
 * @author luojianhong
 * @version $Id: CookieUtils.java, v 0.1 2017年10月13日 上午9:42:50 luojianhong Exp $
 */
public class CookieUtils {
     ...
     * @param domain
     */
    public static void cancleCookie(HttpServletRequest request, HttpServletResponse response,
