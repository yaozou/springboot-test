...
public interface DataBaseConstant {
     ...
     * 有效期
     */
    public static final String EXPIRY_DATE_TABLE          = "expiryDate";
     ...
     * 有效期
     */
    public static final String EXPIRY_TIME_TABLE          = "expiryTime";
     ...
     * token登录用户名称
     */
    public static final String USER_NAME_TABLE="user_name";
    /***
     * token登录用户ID
     */
